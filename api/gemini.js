...
const GEMINI_URL = "https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent?key=AIzaSyAh8XLtsHb4BZVfrHXj6PpHtTSYyFk4bCM"
...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === "POST") {
      ...
      const systemPrompt = `
Kamu adalah asisten AI cerdas bernama Fall AI.
...
Kalau ada yang tanya "Siapa pencipta Fall Official?", jawab: "Fall Official diciptakan oleh Falxz Official."
